...
void loop() {
  ...
  for (int i = 0; i <= 1000; i++) {
    int rpm = map(i, 0, 1000, 1000, 6500);
    int fuel = map(i, 0, 1000, 200, 0);
    int uptime = map(i, 0, 1000, 0, 1000);
    int clt = map(i, 0, 1000, 1500, 2000);
    int afr = map(i, 0, 1000, 90, 160);
    int map1 = map(i, 0, 1000, 130, 2500);
    int tps = map(i, 0, 1000, 0, 1000);
    int batt = map(i, 0, 1000, 100, 140);
    int mat = map(i, 0, 1000, 600, 1200);
    int fuelP = map(i, 0, 1000, 300, 620);
